...
#### Build a REST API with Ottoman JS and Express

> This repo is designed to teach you how to connect to a Couchbase Capella cluster to create, read, update, and delete documents using [Key Value operations](https://ottomanjs.com/docs/quick-start#persist-documents-to-our-bucket) and how to write simple parametrized [SQL++ queries](https://ottomanjs.com/docs/quick-start#write-a-query-with-ottomans-query-api) using the built-in travel-sample bucket. If you want to run this tutorial using a self managed Couchbase cluster, please refer to the [appendix](#appendix-running-self-managed-couchbase-cluster).
